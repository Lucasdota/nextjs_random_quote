  ...
  return (
    <>
      ...
      <main className="bg-[url('../public/images/cozyrest.jpg')] bg-no-repeat bg-cover bg-center bg-fixed text-center w-screen h-screen flex justify-center items-center">
        <div className='w-80 sm:w-4/5 lg:w-2/5 sm:px-5 sm:py-5 mx-2 px-4 py-4 bg-gray-600/20 backdrop-blur rounded grid grid-rows-8 grid-cols-10 shadow-[inset_0_0px_45px_15px_rgba(0,0,0,.4)]' id='quote-box'>
          <GetQuote />
        </div>
        <footer className="absolute top-[96%] w-full text-right pr-4">
          <p className="text-white">by lucasdt</p>
        </footer>
      </main>
    </>
  )

...
function Tweet (props) {
  return (
    <div className="w-16 xs:w-14 md:w-20 h-14 flex justify-center items-center">
      ...
      <a id="tweet-quote" href={`https://twitter.com/intent/tweet?text="${props.msg.quote}"+%20${props.msg.author}%0D%0A%0D%0A&hashtags=quotes,bible,Jesus`} target="_blank" rel="noreferrer" className='overflow-visible'>
        <i className="fab fa-twitter fa-2x 3xl:scale-150 text-white drop-shadow hover:text-sky-500 active:animate-click"></i>
      </a>
    </div>
  )
}
